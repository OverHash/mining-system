...
function Altitude({ depth }: AltitudeProps) {
	return (<screengui ZIndexBehavior={Enum.ZIndexBehavior.Sibling} Key="AltitudeGui" ResetOnSpawn={false}>
		<textlabel
...
RunService.RenderStepped.Connect(() => {
	...
	const characterDepth = math.clamp((humanoidRootPart.Position.Y - humanoidRootPart.Size.Y / 2, settings.blockSize / 2), -math.huge, 0);
